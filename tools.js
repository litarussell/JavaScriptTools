(function (fn) {
  ...
  const arrayFlat = tools.arrayFlat = function (array, depth = 1) {
    let arr = Array.prototype.slice.call(array)
    if (depth === 0) return arr
    return arr.reduce((pre, cur) => {
      if (Array.isArray(cur)) return [...pre, ...arrayFlat.call(this, cur, depth - 1)]
      else return [...pre, cur]
    }, [])
  }
  ...
  var Validator = tools.form = function () {
    this.cache = [];
  }
